...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[12] = _summarize(0, iouThr=.80, maxDets=self.params.maxDets[2])
            stats[13] = _summarize(0, iouThr=.90, maxDets=self.params.maxDets[2])
            stats[14] = _summarize(0, iouThr=.95, maxDets=self.params.maxDets[2])
